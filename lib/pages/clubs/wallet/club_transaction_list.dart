...
class ClubTransactionList extends StatefulWidget {
  final clubid;
  ClubTransactionList({this.clubid});

  @override
  _ClubTransactionListState createState() => _ClubTransactionListState();
}

class _ClubTransactionListState extends State<ClubTransactionList> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder(
                future: Database().getClubTransactions(widget.clubid),
                builder: (context, snapshot) {
                  ...
                  var query = jsonDecode(snapshot.data);
